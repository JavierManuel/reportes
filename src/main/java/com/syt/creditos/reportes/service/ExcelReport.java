...
public class ExcelReport {
    ...
    public static ByteArrayInputStream generarExcel2(ArrayList<String> titulos, ArrayList<Object> datos, ArrayList<String> titulos2, ArrayList<Object> datos2) throws IOException {
        ...
        try (Workbook workbook = new XSSFWorkbook(); ByteArrayOutputStream out = new ByteArrayOutputStream();) {
            ...
            for (int i = 0; i < datos2.size(); i++) {
                ...
                Row headerRow2 = sheet.createRow(i + (!datos.isEmpty() ? (datos.size() + 6) : 6));
    ...
    public static ByteArrayInputStream generarExcelSeguro(String user, ArrayList<String> titulos, ArrayList<Object> datos1, ArrayList<Object> datos2,
                                                           ArrayList<Object> datos3, ArrayList<Object> datos4, ArrayList<Object> datos5) throws IOException {
        ...
        try (Workbook workbook = new XSSFWorkbook(); ByteArrayOutputStream out = new ByteArrayOutputStream();) {
            ...
            Row headerRowSub1 = sheet.createRow(0);
            Cell headerCellSub1 = headerRowSub1.createCell(0);
            headerCellSub1.setCellValue("SEGUROS PAGADOS");
            ...
            Row headerRowSub2 = sheet.createRow(!datos1.isEmpty() ? (datos1.size() + 4) : 4);
            Cell headerCellSub2 = headerRowSub2.createCell(0);
            headerCellSub2.setCellValue("SEGUROS PERDONADOS EJECUTADOS");
            ...
            Row headerRowSub3 = sheet.createRow(!datos2.isEmpty() ? (datos2.size() + 10) : 10);
            Cell headerCellSub3 = headerRowSub3.createCell(0);
            headerCellSub3.setCellValue("SEGUROS PERDONADOS PENDIENTES");
            ...
            Row headerRowSub4 = sheet.createRow(!datos3.isEmpty() ? (datos3.size() + 15) : 15);
            Cell headerCellSub4 = headerRowSub4.createCell(0);
            headerCellSub4.setCellValue("SEGUROS PENDIENTES PAGADOS");
            ...
            Row headerRowSub5 = sheet.createRow(!datos4.isEmpty() ? (datos4.size() + 20) : 20);
            Cell headerCellSub5 = headerRowSub5.createCell(0);
            headerCellSub5.setCellValue("SEGUROS PENDIENTES");
